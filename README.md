...
* Strings - Reversal, permutations, basic string compression
...
* Graphs - BFS, DFS, Finding minimum cuts using kragers algorithm
...
* Integer arrays - partitioning arrays, max-sum sub-array problem
